...
- Vertico: Vertical layout of options in the minibufer
- Marginalia: Additional information to better use the space now introduced by Vertico
- Consult: A collection of enhanced Emacs interactions, might need to overwrite the default ones, e.g. C-x b
- recentf, safehist
- orderless
